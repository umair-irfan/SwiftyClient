...
public protocol Convertible {
    ...
    var baseUrlPath: URL { get }
    
    func urlRequest<T: Codable>(with path: String, method: ClientHTTPMethod,
...
public extension Convertible {
    ...
    func urlRequest<T: Codable>(with path: String, method: ClientHTTPMethod,
        ...
        let url = try constructAPIUrl(with: baseUrlPath, path: path, input: input)
